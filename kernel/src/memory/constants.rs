...
pub const DIRECT_MAP_PDPT_COUNT: usize =
    (MAX_PHYSICAL_ADDR as usize / (PAGE_SIZE * PAGE_TABLE_ENTRIES * PAGE_TABLE_ENTRIES))
        as usize;
...
pub const DIRECT_MAP_PD_COUNT: usize =
    MAX_PHYSICAL_ADDR as usize / (PAGE_SIZE * PAGE_TABLE_ENTRIES);
...
pub const KERNEL_CODE_PDPD: PhysicalAddr =
    DIRECT_MAP_PD.add(DIRECT_MAP_PD_COUNT * PAGE_TABLE_SIZE);
